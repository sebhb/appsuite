...
extension Appsuite {
    ...
    struct GenerateContacts: AsyncParsableCommand {
        static let configuration = CommandConfiguration(commandName: "contacts", abstract: "Generate contacts", discussion: """
            ...
            `probabilityOfAddress` expresses the probability with which a new contact will have a postal address.
            ...
            Only `firstNames` and `lastNames` are required values. Everything else is optional. The default value for `probabilityOfAddress` is 1.
